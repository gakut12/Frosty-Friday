...
if __name__ == "__main__":
    ...
    # Tableを作成するSQL
    create_table_query = f"create or replace table {schema_name}.{table_name} (TAG text, CONTENT text);"
    ...
    try:
        ...
        print(f"Error occurred while creating table: {schema_name}.{table_name} {e}")
